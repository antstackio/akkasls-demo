...
const protoHelper = require('@lightbend/akkaserverless-javascript-sdk/src/protobuf-helper');
const AnySupport = require('@lightbend/akkaserverless-javascript-sdk/src/protobuf-any');
const replicatedData = require('@lightbend/akkaserverless-javascript-sdk/src/replicated-data');
const CommandHelper = require('@lightbend/akkaserverless-javascript-sdk/src/command-helper');
