...
const AnySupport = require('@lightbend/akkaserverless-javascript-sdk/src/protobuf-any');
const EffectSerializer = require('@lightbend/akkaserverless-javascript-sdk/src/effect-serializer');
const ContextFailure = require('@lightbend/akkaserverless-javascript-sdk/src/context-failure');
const Metadata = require('@lightbend/akkaserverless-javascript-sdk/src/metadata');
const CloudEvents = require('@lightbend/akkaserverless-javascript-sdk/src/cloudevents');
const Reply = require('@lightbend/akkaserverless-javascript-sdk/src/reply').Reply;
