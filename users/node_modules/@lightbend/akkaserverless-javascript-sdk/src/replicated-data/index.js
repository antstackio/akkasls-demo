...
const GCounter = require('@lightbend/akkaserverless-javascript-sdk/src/replicated-data/gcounter');
const PNCounter = require('@lightbend/akkaserverless-javascript-sdk/src/replicated-data/pncounter');
const GSet = require('@lightbend/akkaserverless-javascript-sdk/src/replicated-data/gset');
const ORSet = require('@lightbend/akkaserverless-javascript-sdk/src/replicated-data/orset');
const LWWRegister = require('@lightbend/akkaserverless-javascript-sdk/src/replicated-data/lwwregister');
const Flag = require('@lightbend/akkaserverless-javascript-sdk/src/replicated-data/flag');
const ORMap = require('@lightbend/akkaserverless-javascript-sdk/src/replicated-data/ormap');
const Vote = require('@lightbend/akkaserverless-javascript-sdk/src/replicated-data/vote');
