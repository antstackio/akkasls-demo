...
proto.akkaserverless.component.view.ViewStreamIn.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.akkaserverless.component.view.ReceiveEvent.serializeBinaryToWriter);
    }
};
/**
...
proto.akkaserverless.component.view.ViewStreamIn.prototype.getReceive = function () {
    return /** @type{?proto.akkaserverless.component.view.ReceiveEvent} */ (jspb.Message.getWrapperField(this, proto.akkaserverless.component.view.ReceiveEvent, 1));
};
/**
...
proto.akkaserverless.component.view.ReceiveEvent.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(4, f, akkaserverless_component_component_pb.Metadata.serializeBinaryToWriter);
    }
    ...
    f = message.getKey();
    if (f != null) {
        writer.writeMessage(6, f, proto.akkaserverless.component.view.Key.serializeBinaryToWriter);
    }
    f = message.getBySubjectLookupResult();
    if (f != null) {
        writer.writeMessage(7, f, proto.akkaserverless.component.view.Row.serializeBinaryToWriter);
    }
};
/**
...
proto.akkaserverless.component.view.ReceiveEvent.prototype.getMetadata = function () {
    return /** @type{?proto.akkaserverless.component.Metadata} */ (jspb.Message.getWrapperField(this, akkaserverless_component_component_pb.Metadata, 4));
};
/**
...
proto.akkaserverless.component.view.ReceiveEvent.prototype.getKey = function () {
    return /** @type{?proto.akkaserverless.component.view.Key} */ (jspb.Message.getWrapperField(this, proto.akkaserverless.component.view.Key, 6));
};
/**
...
proto.akkaserverless.component.view.ReceiveEvent.prototype.getBySubjectLookupResult = function () {
    return /** @type{?proto.akkaserverless.component.view.Row} */ (jspb.Message.getWrapperField(this, proto.akkaserverless.component.view.Row, 7));
};
/**
...
proto.akkaserverless.component.view.ViewStreamOut.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getUpsert();
    if (f != null) {
        writer.writeMessage(1, f, proto.akkaserverless.component.view.Upsert.serializeBinaryToWriter);
    }
};
/**
...
proto.akkaserverless.component.view.ViewStreamOut.prototype.getUpsert = function () {
    return /** @type{?proto.akkaserverless.component.view.Upsert} */ (jspb.Message.getWrapperField(this, proto.akkaserverless.component.view.Upsert, 1));
};
/**
...
proto.akkaserverless.component.view.Upsert.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getRow();
    if (f != null) {
        writer.writeMessage(1, f, proto.akkaserverless.component.view.Row.serializeBinaryToWriter);
    }
};
/**
 * optional Row row = 1;
...
proto.akkaserverless.component.view.Upsert.prototype.getRow = function () {
    return /** @type{?proto.akkaserverless.component.view.Row} */ (jspb.Message.getWrapperField(this, proto.akkaserverless.component.view.Row, 1));
};
/**
 * @param {?proto.akkaserverless.component.view.Row|undefined} value
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.akkaserverless.component.view.Key.toObject = function (includeInstance, msg) {
        var f, obj = {
            partsList: jspb.Message.toObjectList(msg.getPartsList(), proto.akkaserverless.component.view.KeyPart.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.akkaserverless.component.view.Key.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.akkaserverless.component.view.KeyPart.serializeBinaryToWriter);
    }
};
/**
...
proto.akkaserverless.component.view.Key.prototype.getPartsList = function () {
    return /** @type{!Array<!proto.akkaserverless.component.view.KeyPart>} */ (jspb.Message.getRepeatedWrapperField(this, proto.akkaserverless.component.view.KeyPart, 1));
};
/**
...
proto.akkaserverless.component.view.KeyPart.prototype.getBytesPart_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getBytesPart()));
};
/**
 * optional bytes bytes_part = 2;
...
proto.akkaserverless.component.view.KeyPart.prototype.getBytesPart_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getBytesPart()));
};
/**
...
proto.akkaserverless.component.view.Row.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getKey();
    if (f != null) {
        writer.writeMessage(2, f, proto.akkaserverless.component.view.Key.serializeBinaryToWriter);
    }
    f = message.getValue();
    if (f != null) {
        writer.writeMessage(3, f, google_protobuf_any_pb.Any.serializeBinaryToWriter);
...
proto.akkaserverless.component.view.Row.prototype.getKey = function () {
    return /** @type{?proto.akkaserverless.component.view.Key} */ (jspb.Message.getWrapperField(this, proto.akkaserverless.component.view.Key, 2));
};
/**
 * @param {?proto.akkaserverless.component.view.Key|undefined} value
 * @return {!proto.akkaserverless.component.view.Row} returns this
...
//# sourceMappingURL=view_pb.js.map