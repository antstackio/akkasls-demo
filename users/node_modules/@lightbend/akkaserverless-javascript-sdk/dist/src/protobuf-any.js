...
class AnySupport {
    ...
    static isPrimitiveDefaultValue(obj, type) {
        if (Long.isLong(obj))
            return obj.equals(Long.ZERO);
        else if (Buffer.isBuffer(obj))
            return !obj.length;
        else
            return obj === protobuf.types.defaults[type];
    }
    static serializePrimitiveValue(obj, type) {
        if (this.isPrimitiveDefaultValue(obj, type))
            return EmptyArray;
        ...
        writer.uint32((AkkaServerlessPrimitiveFieldNumberEncoded |
        ...
        while (reader.pos < reader.len) {
            ...
            if (fieldNumber !== AkkaServerlessPrimitiveFieldNumber) {
                ...
                if (pType !== protobuf.types.basic[type]) {
                    throw new Error('Unexpected protobuf type ' +
                        pType +
                        ', was expecting ' +
                        protobuf.types.basic[type] +
                        ' for decoding a ' +
