...
const fs = require('fs');
const settings = require('@lightbend/akkaserverless-javascript-sdk/settings');

const discovery_messages = require('@lightbend/akkaserverless-javascript-sdk/proto/akkaserverless/protocol/discovery_pb');
const discovery_services = require('@lightbend/akkaserverless-javascript-sdk/proto/akkaserverless/protocol/discovery_grpc_pb');
...
const pkgInfo = require('@lightbend/akkaserverless-javascript-sdk/src/package-info');
