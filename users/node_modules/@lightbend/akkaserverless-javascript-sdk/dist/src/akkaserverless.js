...
class AkkaServerless {
    ...
    constructor(options) {
        ...
        try {
            ...
            console.error('Unable to read protobuf descriptor from: ' +
    ...
    start(options) {
        ...
        return new Promise((resolve, reject) => {
            this.server.bindAsync(opts.bindAddress + ':' + opts.bindPort, grpc.ServerCredentials.createInsecure(), (err, port) => {
                if (err) {
    ...
    reportErrorLogic(userError) {
        let msg = 'Error reported from Akka system: ' +
            userError.getCode() +
            ' ' +
