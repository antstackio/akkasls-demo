...
class EventSourcedEntity {
    ...
    constructor(desc, serviceName, entityType, options) {
        ...
        if (!entityType)
            throw Error('EntityType must contain a name');
        const allIncludeDirs = protobufHelper.moduleIncludeDirs.concat(this.options.includeDirs);
...
//# sourceMappingURL=event-sourced-entity.js.map